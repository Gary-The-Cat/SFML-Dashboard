...
namespace Shared.Menus
{
    public class Button : Drawable
    {
        ...
        private Func<Task> funcCallback;
        ...
        public Button(
            ...
            Vector2f position,
            Action callback,
            HorizontalAlignment buttonHorizontalAlignment = HorizontalAlignment.Centre)
        {
            ...
            {
                FillColor = new Color(0x78, 0x90, 0x9c),
                OutlineColor = new Color(233, 233, 233),
                OutlineThickness = 2
            };
