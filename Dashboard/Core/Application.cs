...
namespace Dashboard.Core
{
    public class Application : IApplication
    {
        ...
        private void ConfigureKernel()
        {
            ...
            kernel.Bind<IRenderInstanceService>().To<RenderInstanceService>()
                .InSingletonScope()
                .WithConstructorArgument("target", this.window);
        }
        ...
        public void Run()
        {
            ...
            try
            {
                ...
                while (window.IsOpen)
                {
                    ...
                    applicationManager.OnUpdate(timer.Restart().AsSeconds());
